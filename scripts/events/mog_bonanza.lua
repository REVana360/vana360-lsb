...
local rewardList =
{
    ...
    [2] =
    {
        ...
        rewardItems =
        {
            ...
            [ 1] = xi.item.MOG_KUPON_I_AF119,
            [ 2] = xi.item.MOG_KUPON_AW_VGR,
            [ 3] = xi.item.MOG_KUPON_I_RME,
            [ 4] = xi.item.MOG_KUPON_W_PULSE,
            [ 5] = xi.item.MOG_KUPON_AW_VGRII,
            [ 6] = xi.item.MOG_KUPON_W_JOB,
            [ 7] = xi.item.MOG_KUPON_A_DEII,
            [ 8] = xi.item.MOG_KUPON_W_DEIII,
            [ 9] = xi.item.WAILING_BELT,
            [10] = xi.item.SHAPERS_SHAWL,
            [11] = xi.item.TEN_THOUSAND_BYNE_BILL,
            [12] = xi.item.RANPERRE_GOLDPIECE,
            [13] = xi.item.RIMILALA_STRIPESHELL,
            [14] = xi.item.BAYLD_CRYSTAL,
            [15] = xi.item.DENSE_CLUSTER,
            [16] = xi.item.CATS_EYE,
            [17] = xi.item.MOG_KUPON_AW_GFIII,
            [18] = xi.item.LU_SHANGS_FISHING_ROD,
        },
    },
    ...
    [3] =
    {
        ...
        rewardItems =
        {
            [ 0] = xi.item.MOG_KUPON_AW_COS,
            [ 1] = xi.item.AUCUBA_CROWN,
            [ 2] = xi.item.CURMUDGEONS_HELMET,
            [ 3] = xi.item.GAZERS_HELMET,
            [ 4] = xi.item.RETCHING_HELMET,
            [ 5] = xi.item.KARAKUL_CAP,
            [ 6] = xi.item.HOTENGEKI,
            [ 7] = xi.item.GRUDGE,
            [ 8] = xi.item.PLUTON_COFFER,
            [ 9] = xi.item.BEITETSU_COFFER,
            [10] = xi.item.RIFT_BOULDER_COFFER,
            [11] = xi.item.MARBLE_MOG_PELL,
            [12] = xi.item.OCHRE_MOG_PELL,
            [13] = xi.item.MARS_ORB,
            [14] = xi.item.CHOCOBO_ROPE,
            [15] = xi.item.CHOCOBO_TORQUE,
            [16] = xi.item.MOG_KUPON_A_SAP,
            [17] = xi.item.MOG_KUPON_A_JAD,
            [18] = xi.item.MOG_KUPON_A_RUB,
            [19] = xi.item.DEMONIC_AXE,
            [20] = xi.item.BRAVE_BLADE_II,
            [21] = xi.item.ONION_SWORD_II,
            [22] = xi.item.MOG_KUPON_I_ORCHE,
            [23] = xi.item.SHEET_OF_PROMATHIAN_TUNES,
            [24] = xi.item.SHEET_OF_ADOULINIAN_TUNES,
        },
    },
}
